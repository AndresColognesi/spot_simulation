...
class PublishThread(threading.Thread):
    def __init__(self, rate, spot_name):
        ...
        self.YawRate = 0.0
        self.StepVelocity = 0.8 #Spot: 1.1 | MiniMini: 1.1 | LaikaGo: 0.8 for spot, and 0.7 for laikago
        self.ClearanceHeight = 0.07 #Spot: 0.1 | MiniMini: 0.06 | LaikaGo: 0.08 for spot, and 0.07 for laikago
        self.PenetrationDepth = 0.003
        self.SwingPeriod = 0.25 #Spot: 0.25 | MiniMini: 0.25 | LaikaGo: 0.25
        self.YawControl = 0.0
...
if __name__ == "__main__":
    ...
    step = rospy.get_param("~step", 0.11) #Spot: 0.11 | MiniMini: 0.11 | LaikaGo: 0.11
    turn = rospy.get_param("~turn", 2.5) #Spot: 0.35 | MiniMini: 0.35 | LaikaGo: 0.30
