...
class PublishThread(threading.Thread):
    def __init__(self, rate, spot_name):
        ...
        self.x = 0.0
        self.y = 0.0
        self.z = 0.1 #Spot: 0.1 | MiniMini: 0.1 | LaikaGo: 0.0
        self.roll = 0.0
        self.pitch = 0.0
        self.yaw = 0.0
        ...
        self.YawRate = 0.0
        self.StepVelocity = 1.1 #Spot: 1.1 | MiniMini: 1.1 | LaikaGo: 0.8
        self.ClearanceHeight = 0.1 #Spot: 0.1 | MiniMini: 0.06 | LaikaGo: 0.08
        self.PenetrationDepth = 0.003
        self.SwingPeriod = 0.25 #Spot: 0.25 | MiniMini: 0.25 | LaikaGo: 0.2
        self.YawControl = 0.0
